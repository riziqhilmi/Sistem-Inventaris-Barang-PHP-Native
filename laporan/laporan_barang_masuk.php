...
// Mengambil data barang masuk berdasarkan rentang tanggal
$transactions = [];
...
function generatePDF($transactions) {
    ...
    // Output PDF
    $pdf->Output('laporan_barang_masuk.pdf', 'D'); // 'D' untuk download
    exit();
}
...
function generateExcel($transactions) {
    ...
    $filename = 'laporan_barang_masuk.xls'; // Ganti ekstensi menjadi .xls
    header('Content-Type: application/vnd.ms-excel'); // Mengubah header untuk Excel
